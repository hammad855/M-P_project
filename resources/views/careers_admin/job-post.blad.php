...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ asset("careers_assetscss/style.css") }}" rel="stylesheet">
        <link href="{{ asset("careers_assetscss/colors/blue.css") }}" id="theme" rel="stylesheet">
          ...
          @include("careers_admin.includes.sidebar")
            ...
            <div id="page-wrapper">
                                                    ...
                                                    <div class="white-box">
                                                        ...
                                                        <form  id="validation" class="form-horizontal">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-12">
                                                                     <div id="bloodhound">
                                                                        <input class="typeahead form-control" type="text" placeholder="Company"> 
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-10 col-sm-12">
                                                    <div class="white-box">
                                                        ...
                                                        <form method="post">
                                                            <div class="form-group">
                                                                <textarea class="textarea_editor form-control" style="width: 100%;" rows="15" placeholder="Enter text ...">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="tags-default mywidth-100">
                                                                    <input type="text" value="Amsterdam,Washington,Sydney" data-role="tagsinput" placeholder="Add Skills" style="width:100%;" /> 
                                                                </div>
                                                            </div> 
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        ...
                                                                        <div>
                                                                            <input class="typeahead form-control" type="email" placeholder="Email Address">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                                ...
                                                                                <div class="panel-body">
                                                                                    <div class="row">
                                                                                        <div class="col-md-4">
                                                                                            ...
                                                                                            <div id="bloodhound">
                                                                                                <input class="typeahead form-control" type="text" placeholder="Tool or Technology:"> 
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-md-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <div>
                                                                                                    <textarea class="form-control" rows="1" placeholder="Try asking a question like, “Will you be able to bring your own device?”" style="resize:none;"></textarea>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>  
                ...
                <footer class="footer foss-logo text-center"> 
                    2021 © All rights reserved. Made Love by <a href="https://fossphorus.com/"> <img src="../plugins/images/foss.png" alt="">Fossphorus</a> 
                </footer>
            </div>
        </div>
