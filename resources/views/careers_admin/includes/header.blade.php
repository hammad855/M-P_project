<nav class="navbar navbar-default navbar-static-top m-b-0">
    <div class="navbar-header"> 
        ...
        <div class="top-left-part">
            <a class="logo mylogo" href="index.html">
                <img src="{{ asset("careers_assets/plugins/images/eliteadmin-text.png") }}" alt="home" />
            </a>
        </div>
        ...
        <ul class="nav navbar-top-links navbar-right pull-right">
            ...
            <li class="dropdown">
                <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#">
                    <img src="{{ asset("careers_assets/plugins/images/users/blank-user.jpg") }}" alt="user-img" width="36" class="img-circle">
                ...
                <ul class="dropdown-menu dropdown-user animated flipInY">
                    ...
                    <li><a href="change-password.html"><i class="ti-key"></i> Change Password</a></li>
                    <li role="separator" class="divider"></li>
